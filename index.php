...
<head>
    ...
    <meta property="og:image" content="images/278028755_106243695388538_8023480144971372750_n.png">
    ...
    <div class="container">
        <div class="card">
            <div class="card-header" style="background-color: #0593a1; color: whitesmoke">
                <h1>THCS Châu Văn Biếc Confession</h1>
            </div>
            <div class="card-body">
                <h5 class="card-title">Chào mừng các bạn đã đến với THCS Châu Văn Biếc confession!! </h5>
                <p class="card-text">
